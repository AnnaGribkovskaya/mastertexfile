...
\ket{\Psi_{\text{CI}}}= N_0 e^{\hat{T}}\ket{D_0},
\end{equation}
where $N_0$ determines the normalization of wave function and the equation for cluster operator $\hat{T}$ is presented in Chapter $\ref{ch:coupled_cluster}$ by equation ($\ref{eq:T}$). 
