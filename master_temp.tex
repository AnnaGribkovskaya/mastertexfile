...
\subsubsection{The CCD results for QD}
...
\subsubsection{The CCD results for HEG}
\begin{table}[h]
	\centering
...
\begin{landscape}
	...
	\begin{table}[h]
		...
		\begin{tabular}{rrllll}
			$r_s$ & States & $\Delta E_{CCD}$ \cite{millerAntumMechanicalStudies} & $\Delta E_{CCD}$ \cite{HansenCoupledclusterstudies} & $\Delta E_{CCD}$ \cite{gustavbaardsenCoupledclusterTheoryInfinite2014}  & $\Delta E_{CCD}$\\
			\hline
			\hline
